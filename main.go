...
import (
	...
	"github.com/DoodleScheduling/ratelimit-controller/internal/controllers"
...
const controllerName = "ratelimit-controller"
...
func main() {
	...
	opts := ctrl.Options{
		...
		Cache: ctrlcache.Options{
			ByObject: map[ctrlclient.Object]ctrlcache.ByObject{
				&infrav1beta1.RateLimitService{}: {Label: watchSelector},
				&infrav1beta1.RateLimitRule{}:    {Label: watchSelector},
			},
		},
	}
	...
	hubReconciler := &controllers.RateLimitServiceReconciler{
